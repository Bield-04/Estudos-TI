...
Aceita números finitos, inclusive decimais, negativos e valores repetidos. Não usa LINQ nem métodos prontos para maior/menor.
...
```bash
dotnet run --project ./14_MaiorMenorTres/Exercicio14.csproj
```
